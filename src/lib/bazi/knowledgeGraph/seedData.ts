...
// C7-2: applicability 模板常量（适用范围）
const APP_WUXING = { scope: '通用', conditions: ['任何命盘'], exclusions: [] as string[] }
const APP_TIANGAN = { scope: '日干判断', conditions: ['日主为该天干'], exclusions: ['从格不适用'] }
const APP_TIANGAN_HE = { scope: '天干合化', conditions: ['两干相邻', '无克制'], exclusions: ['隔位不合', '有冲不成'] }
const APP_DIZHI_CLASH = { scope: '地支关系', conditions: ['两支同现'], exclusions: [] as string[] }
const APP_DIZHI_SANHE = { scope: '地支关系', conditions: ['三支同现', '无冲破'], exclusions: ['缺一支为半合'] }
const APP_DIZHI_LIUHE = { scope: '地支关系', conditions: ['两支相邻', '无冲破'], exclusions: ['隔位不合'] }
const APP_DIZHI_XING = { scope: '地支关系', conditions: ['刑支同现'], exclusions: [] as string[] }

// C7-2: exceptionCondition 模板常量（例外条件）
const EXC_WUXING = ['从格格局中可能反转']
const EXC_TIANGAN = ['从格中喜忌反转', '化气格中不以原干论']
const EXC_TIANGAN_HE = ['有冲不成合', '化气条件不足则不化']
const EXC_DIZHI_SANHE = ['有冲破则不合', '缺一支不成三合']
...
edges.push(
  { id: 'e:wx-gen-1', from: 'wx:木', to: 'wx:火', type: 'generates', reason: '木生火', classicSource: '渊海子平', originalText: '木生火，火生土，土生金，金生水，水生木',
    ...
    applicability: APP_WUXING, exceptionCondition: EXC_WUXING },
...
edges.push(
  { id: 'e:tg-like-1', from: 'tg:甲', to: 'tg:丙', type: 'likes', reason: '寒木向阳', classicSource: '穷通宝鉴', originalText: '甲木参天，三春甲木先用丙火后用癸水', chapter: '春木',
    ...
    applicability: APP_TIANGAN, exceptionCondition: EXC_TIANGAN },
...
edges.push(
  { id: 'e:tg-combine-1', from: 'tg:甲', to: 'tg:己', type: 'combines', reason: '甲己合化土', classicSource: '渊海子平', condition: '两干紧贴、得月令化气则化土', chapter: '论化合',
    ...
    applicability: APP_TIANGAN_HE, exceptionCondition: EXC_TIANGAN_HE },
...
edges.push(
  { id: 'e:dz-sanhe-1', from: 'dz:申', to: 'dz:子', type: 'combines', reason: '申子辰三合水局', classicSource: '渊海子平', condition: '申子辰三支全见方成水局，子为将星', chapter: '论三合',
    ...
    applicability: APP_DIZHI_SANHE, exceptionCondition: EXC_DIZHI_SANHE },
