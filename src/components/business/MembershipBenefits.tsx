...
var TIERS = [
  ...
  },
  {
    ...
    name: '基础会员',
    price: '29',
    features: ['每日 10 次排盘', '每日 5 次分析', '完整八字分析', 'PDF 导出', '3 次深度解读', '50 条历史'],
    highlight: false,
  },
  {
    key: 'premium',
    name: '高级会员',
    price: '99',
    features: ['无限排盘', '无限分析', '专业报告', '全部 PDF', '20 次深度推演解读', '无限历史', '高级流年分析', '玄机推演建议'],
    highlight: true,
  },
  {
    key: 'vip',
    name: 'VIP 尊享',
    price: '299',
    features: ['全部高级功能', '无限推演', '优先客服', '优先体验新功能', '专属客服通道', '年度运势分析'],
    highlight: false,
  },
]
